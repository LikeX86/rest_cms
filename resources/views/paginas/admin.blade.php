...
<body class="layout-fixed layout-navbar-fixed sidebar-mini" >
    ...
    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <li class="user-footer">
                            <a href="http://127.0.0.1:8000/painel/configuracoes" class="btn btn-default btn-flat">
            ...
            <form id="logout-form" action="{{route('logout')}}" method="POST" style="display: none;">
                                <input type="hidden" name="_token" value="NBC5WxmMy9wEQr84WfEouXy7tgZuW51M4Zx8FoAC">
         {{ csrf_field() }}
 </form>
    ...
    @foreach($config_geral as $config)
        ...
        <b style="color:{{$config->cor}}"> {{$config->name}}</b>
        </span>
    @endforeach
...
<li  class="nav-item">
    ...
    <a class="nav-link active "
       href="http://127.0.0.1:8000/painel/home"        >
...
<li  class="nav-item has-treeview ">
    ...
    <a class="nav-link  "
       href="http://127.0.0.1:8000/painel/posts"        >
...
<li  class="nav-item">
    ...
    <a class="nav-link  "
       href="http://127.0.0.1:8000/painel/listar-usuarios"        >
